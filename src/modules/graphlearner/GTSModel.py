...
class GTSModel(nn.Module, Seq2SeqAttrs):
    ...
    def __init__(self, temperature, logger, model_kwargs):
        ...
        Con_2_hid = 16
        pad_size = 2
        self.dim_fc = (model_kwargs.get('dim_fc') - 2) * Con_2_hid  # int(model_kwargs.get('dim_fc', False) - pad_size + 1 - pad_size + 1) * Con_2_hid
        self.embedding_dim = 100
        self.conv1 = torch.nn.Conv1d(model_kwargs.get('channels'), Con_1_hid, pad_size, stride=1)
