...
#SBATCH --job-name=r-mappo    # Nom du job
#SBATCH --output=r-mappo_%j.log   # Standard output et error log
...
cd ~/epymarl/
# run Python script
python src/main.py --seed=2 --config=r-mappo --env-config=gymma with env_args.key="mpe2-simple-tag-v3" env_args.pretrained_wrapper="FrozenTag"
